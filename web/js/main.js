...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, \"default\", function() { return ProductPrefetch; });\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/regenerator */ \"./node_modules/@babel/runtime/regenerator/index.js\");\n/* harmony import */ var _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0__);\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/asyncToGenerator */ \"./node_modules/@babel/runtime/helpers/asyncToGenerator.js\");\n/* harmony import */ var _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1__);\n/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ \"./node_modules/@babel/runtime/helpers/classCallCheck.js\");\n/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2__);\n/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ \"./node_modules/@babel/runtime/helpers/createClass.js\");\n/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3__);\n/* harmony import */ var _Fetcher__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./Fetcher */ \"./src/js/partials/Fetcher.js\");\n/* harmony import */ var _Product__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./Product */ \"./src/js/partials/Product.js\");\n\n\n\n\n\n\n\nvar ProductPrefetch =\n/*#__PURE__*/\nfunction () {\n  /**\r\n   * Prepare buffered product prefetching starting from page nextPage.\r\n   * Issuing initial prefetch.\r\n   * @param nextPage\r\n   */\n  function ProductPrefetch(nextPage) {\n    _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_2___default()(this, ProductPrefetch);\n\n    this._fetcher = new _Fetcher__WEBPACK_IMPORTED_MODULE_4__[\"default\"]('/list.php');\n    this.nextPage = nextPage;\n    this._buffer = [];\n    this.activeQuery = null;\n    this.fetchNext();\n    this.items_total = -1; // used to make decision that total isn't available yet\n\n    this.items_fetched = 4; //initial per_page number\n  }\n  /**\r\n   * Fill buffer with server data\r\n   * @returns {Promise<void>}\r\n   */\n\n\n  _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_3___default()(ProductPrefetch, [{\n    key: \"fetchNext\",\n    value: function () {\n      var _fetchNext = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(\n      /*#__PURE__*/\n      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee() {\n        var _this = this;\n\n        var data;\n        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee$(_context) {\n          while (1) {\n            switch (_context.prev = _context.next) {\n              case 0:\n                this.activeQuery = this._fetcher.getProducts(this.nextPage); // data for the next page from buffer point of view\n                // save promise to activeQuery class field to inform other class parts that query is in action\n\n                _context.next = 3;\n                return this.activeQuery;\n\n              case 3:\n                data = _context.sent;\n                // waiting for query to finish\n                data.entities.forEach(function (pr) {\n                  _this._buffer.push(new _Product__WEBPACK_IMPORTED_MODULE_5__[\"default\"](pr)); // creating products and store them into the buffer\n\n                });\n                this.nextPage += 1; // increment page pointer for buffer\n\n                this.items_total = data.total; // set total\n\n                this.items_fetched += data.entities.length; // increment already fetched items counter (ex. 4 + 4)\n\n                this.activeQuery = null; // query finished now\n\n              case 9:\n              case \"end\":\n                return _context.stop();\n            }\n          }\n        }, _callee, this);\n      }));\n\n      function fetchNext() {\n        return _fetchNext.apply(this, arguments);\n      }\n\n      return fetchNext;\n    }()\n    /**\r\n     * get data from buffer or from server (if buffer is empty)\r\n     * returns status when end of products list reached\r\n     * @returns {Promise<{arrProd: Array, status: boolean}>}\r\n     */\n\n  }, {\n    key: \"getBufferResults\",\n    value: function () {\n      var _getBufferResults = _babel_runtime_helpers_asyncToGenerator__WEBPACK_IMPORTED_MODULE_1___default()(\n      /*#__PURE__*/\n      _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.mark(function _callee2() {\n        var ret, status, bufferRes;\n        return _babel_runtime_regenerator__WEBPACK_IMPORTED_MODULE_0___default.a.wrap(function _callee2$(_context2) {\n          while (1) {\n            switch (_context2.prev = _context2.next) {\n              case 0:\n                ret = [];\n                status = true;\n\n                if (!(this._buffer.length > 0)) {\n                  _context2.next = 6;\n                  break;\n                }\n\n                //* Return data from buffer\n                ret = this._buffer.splice(0, 4); // cut from buffer\n\n                _context2.next = 14;\n                break;\n\n              case 6:\n                if (!(this.activeQuery === null)) {\n                  _context2.next = 11;\n                  break;\n                }\n\n                _context2.next = 9;\n                return this._fetcher.getProducts(this.nextPage);\n\n              case 9:\n                _context2.next = 13;\n                break;\n\n              case 11:\n                _context2.next = 13;\n                return this.activeQuery;\n\n              case 13:\n                ret = this._buffer.splice(0, 4);\n\n              case 14:\n                // Shedule next buffer filling\n                if ((this.items_fetched < this.items_total || this.items_total < 0) && this.activeQuery === null) {\n                  this.fetchNext();\n                }\n\n                if (this.items_fetched >= this.items_total) {\n                  //reached product list end\n                  status = false;\n                }\n\n                bufferRes = {\n                  arrProd: ret,\n                  status: status\n                };\n                return _context2.abrupt(\"return\", bufferRes);\n\n              case 18:\n              case \"end\":\n                return _context2.stop();\n            }\n          }\n        }, _callee2, this);\n      }));\n\n      function getBufferResults() {\n        return _getBufferResults.apply(this, arguments);\n      }\n\n      return getBufferResults;\n    }()\n  }]);\n\n  return ProductPrefetch;\n}();\n\n\n\n//# sourceURL=webpack:///./src/js/partials/ProductPrefetch.js?");
